...
demon_names = {d: {'health': 0, 'damage': 0.0} for d in delimit.split(input())}
...
for name in demon_names:
    ...
    demon_names[name] = {'health': total_health, 'damage': base_damage}

sorted_names = dict(sorted(demon_names.items()))
